...
import {  preFlightMiddleware,getSupabaseClient } from "../_shared/express_utils.ts";
...
app.get("/user_ticker/tickers/", async (
    req: Request,
    res: Response,
) => {
...
app.post("/user_ticker/tickers/", async (
    req: Request,
    res: Response,
) => {
    const [_supabase,user] =await getSupabaseClient(req,res);
...
app.delete("/user_ticker/tickers/", async (
    req: Request,
    res: Response,
) => {
    const [_supabase,user] =await getSupabaseClient(req,res);
...
app.put("/user_ticker/tickers/", async (
    req: Request,
    res: Response,
) => {
    const [_supabase,user] =await getSupabaseClient(req,res);
